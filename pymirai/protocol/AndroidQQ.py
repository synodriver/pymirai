...
class AndroidQQ(object):
    ...
    def Pack_Login(self):
        ...
        pack.write_bytes(
            Tlv.tlv106(self.qq, self.md5pass, self.md52pass, self.tgtkey, self.deviceguid, self.starttime, self.appid))
        ...
        pack.write_bytes(Tlv.tlv144(self.tgtkey, Tlv.tlv109(self.AndroidId), Tlv.tlv124(),
    ...
    def Pack_LoginHead(self, pkt, mtype):
        ...
        if self.xy == 1:
            ...
            pack.write_hex(
                '62 24 31 65 62 63 38 35 64 65 37 33 36 35 64 65 34 64 31 35 35 63 65 34 30 31 31 30 30 30 31 35 38 31 34 37 31 64')
